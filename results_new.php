...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-12 col-lg-12">
			...
			<p><h2>Nowe badanie</h2></p><br>

			</center>			

		
			<FORM NAME="forma" METHOD="POST" ACTION="results_safe.php" class="form-horizontal">
				...
				<div class="bg-light">
					<div class="form-group row bg-warning align-items-center">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="date" id="inputDate" placeholder="" value="<?php echo date('Y-m-d H:i:s');?>">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="oxy1" id="inputOxy1" placeholder="" onChange="test(1,this)" value="" autofocus>
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-6 col-lg-2">
							<input type="text" class="form-control" name="presureA1" id="inputPresureA1" placeholder="skurczowe" onChange="test(2,this)" value="">
						</div>
						<div class="col-6 col-lg-3">
							<input type="text" class="form-control" name="presureB1" id="inputPresureB1" placeholder="rozkurczowe" onChange="test(3,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="pulse1" id="inputPulse1" placeholder="" onChange="test(4,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="distance1" id="inputDistance1" placeholder="" onChange="test(0,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="time1" id="inputTime1" placeholder="" onChange="test(5,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="oxy1e" id="inputOxy1e" placeholder="" onChange="test(1,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-6 col-lg-2">
							<input type="text" class="form-control" name="presureA1e" id="inputPresureA1e" placeholder="skurczowe" onChange="test(2,this)" value="">
						</div>
						<div class="col-6 col-lg-3">
							<input type="text" class="form-control" name="presureB1e" id="inputPresureB1e" placeholder="rozkurczowe" onChange="test(3,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="pulse1e" id="inputPulse1e" placeholder="" onChange="test(4,this)" value="">
						</div>
				...
				<div>
					<div class="form-group row bg-info align-items-center">
						...
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="comfort" id="inputComfort1" value="1">
							<label class="form-check-label" for="inlineRadio1">Bardzo złe</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="comfort" id="inputComfort2" value="2">
							<label class="form-check-label" for="inlineRadio2">Złe</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="comfort" id="inputComfort3" value="3" checked>
							<label class="form-check-label" for="inlineRadio3">Trudno powiedzieć</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="comfort" id="inputComfort4" value="4">
							<label class="form-check-label" for="inlineRadio4">Dobre</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="comfort" id="inputComfort5" value="5">
				...
				<div class="bg-warning">
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="oxy2" id="inputOxy2" placeholder="" onChange="test(1,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-6 col-lg-2">
							<input type="text" class="form-control" name="presureA2" id="inputPresureA2" placeholder="skurczowe" onChange="test(2,this)" value="">
						</div>
						<div class="col-6 col-lg-3">
							<input type="text" class="form-control" name="presureB2" id="inputPresureB2" placeholder="rozkurczowe" onChange="test(3,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="pulse2" id="inputPulse2" placeholder="" onChange="test(4,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="distance2" id="inputDistance2" placeholder="" onChange="test(0,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="time2" id="inputTime2" placeholder="" onChange="test(5,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="oxy2e" id="inputOxy2e" placeholder="" onChange="test(1,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-6 col-lg-2">
							<input type="text" class="form-control" name="presureA2e" id="inputPresureA2e" placeholder="skurczowe" onChange="test(2,this)" value="">
						</div>
						<div class="col-6 col-lg-3">
							<input type="text" class="form-control" name="presureB2e" id="inputPresureB2e" placeholder="rozkurczowe" onChange="test(3,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="pulse2e" id="inputPulse2e" placeholder="" onChange="test(4,this)" value="">
						</div>
				...
				<div class="bg-secondary">
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="oxy3" id="inputOxy3" placeholder="" onChange="test(1,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-6 col-lg-2">
							<input type="text" class="form-control" name="presureA3" id="inputPresureA3" placeholder="skurczowe" onChange="test(2,this)" value="">
						</div>
						<div class="col-6 col-lg-3">
							<input type="text" class="form-control" name="presureB3" id="inputPresureB3" placeholder="rozkurczowe" onChange="test(3,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="pulse3" id="inputPulse3" placeholder="" onChange="test(4,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="distance3" id="inputDistance3" placeholder="" onChange="test(0,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="time3" id="inputTime3" placeholder="" onChange="test(5,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="oxy3e" id="inputOxy3e" placeholder="" onChange="test(1,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-6 col-lg-2">
							<input type="text" class="form-control" name="presureA3e" id="inputPresureA3e" placeholder="skurczowe" onChange="test(2,this)" value="">
						</div>
						<div class="col-6 col-lg-3">
							<input type="text" class="form-control" name="presureB3e" id="inputPHaslo" placeholder="rozkurczowe" onChange="test(2,this)" value="">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-12 col-lg-5">
							<input type="text" class="form-control" name="pulse3e" id="inputPulse3e" placeholder="" onChange="test(4,this)" value="">
						</div>
